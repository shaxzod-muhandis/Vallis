...
import ExpenseTable from "./_expenseTableBody";
...
class Table extends Component {
  ...
  handleTableBody = () => {
    if (this.props.name === "buyProduct") {
      return <BuyTableBody orderList={this.props.orderList.data} />;
    ...
    else if (this.props.name === "reportList") {
      return (
        <ReportTableBody
          reportList={this.props.orderList}
          deleteFunction={this.props.deleteFunction}
        />
      );
    }
  ...
  componentDidUpdate(){
    console.log(this.props.newWarehouseId);
  }

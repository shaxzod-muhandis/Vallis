...
class Expense extends Component {
  ...
  getUsersData = async () => {
    ...
    instance.get(url).then((res) => this.setState({ usersdata: res.data }));
  };

  getUserList = () => {
    const url = "/user/user-list/";
    instance.get(url).then((res) => this.setState({ userList: res.data }));
  };
  ...
  onUpdate = (e) => {
    e.preventDefault();
    const url = `/expense_discount/expense-detail/${this.state.id}/`;

...
class CreatePlan extends Component {
  ...
  getPlans = () => {
    const url = "/plan/plan-list/";
    instance(url).then((res) => this.setState({ plans: res.data }));
  };

  getProducts = () => {
    const url = "/product/product-list/";
    instance(url).then((res) => this.setState({ products: res.data.products }));
  };
  getAgent = () => {
    const url = "/user/agent-list/";
    instance(url).then((res) => this.setState({ agents: res.data }));
  };
  handlePlanItem = (e) => {
    this.setState({
  ...
  handleCreatingPlanItem = (e) => {
    ...
    instance.post("/plan/plan-item-create/", data);
    this.setState(
      {
  ...
  handleCreatingAgentPlan = (e) => {
    ...
    instance.post("/plan/agent-plan-list/", data);
    this.setState(
      {
  ...
  ShowAgentPlans = (e) => {
    const url = `/plan/agent-plan-detail/${e}`;
    instance(url).then((res) => this.setState({ AgentPlanList: res.data }));
  };
  ShowPlanItems = (e) => {
    const url = `/plan/plan-product-list/${e}`;
    instance(url).then((res) => this.setState({ PlanList: res.data }));
  };
  render() {

      ...
      <>
        ...
        <div className="crm-page-header _expense">
          ...
          {/* <div className="crm-box">
            ...
            <div className="count">{salarydata.total_expense + " $"}</div>
        ...
        <DataTable
          name={name}
          headers={headers}
          url={"/expense_discount/expense-list/"}
          // url = {"/salary/salary-list/"}
          deleteUrl={"/expense_discount/expense-detail/"}
          // deleteUrl = {"/salary/salary-list/"}
        />
      </>
    );
  }

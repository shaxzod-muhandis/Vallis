        ...
        <nav className={this.state.click ? 'navbar ' : 'navbar toggle'}>
          ...
          <div className="navbar-right">
            ...
            <div
             ...
             >
              <i
                className={this.state.mode === false ? "fas fa-moon" : "fas fa-sun"}
              ></i>
            </div> */}
          </div>
        </nav>
        <div className={this.state.click ? 'sm-sidebar-box toggle' : 'sm-sidebar-box '}>
            ...
            <ul>
              <li>
                ...
                <div className="sub-menu">
                  <NavLink to="/director/product">Sotib Olingan Mahsulotlar</NavLink>
                </div>
              </li>
              <li>
                <a href="/">

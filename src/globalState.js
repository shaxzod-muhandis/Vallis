...
export const getToken = globalState.token;

export const getRoles = () => {
    console.log(globalState.user.role)
...
export const setTasdiqlashArray = action(
  (elemId, productId, clientId, narx, quantity, _given_quantity, discount, product_discount) => {
    let elem = {
      id: elemId,
